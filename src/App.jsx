...
export default function TodoApp() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat px-4 md:px-10 lg:px-20" style={{ backgroundImage: `url(${backgroundImage})` }}>
